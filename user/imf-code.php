                        ...
                        if($_SESSION['wire-transfer']){
                            ...
                            <div class="user-profile">
                                ...
                                <form action="" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="text-center text-info text-uppercase">HELLO, <?= $fullName?>  KINDLY CONTACT SUPPORT VIA <a class="a-custome" href="mailto:support@fortageunion.com">support@fortageunion.com</a> TO GET YOUR IMF CODE
                                            <br>
                                            <span class="custom-charge">
                                                Please Note: Charges may apply
                                            </span>
                                            
                                            
                                            <!--KINDLY INSERT YOUR IMF CODE TO COMPLETE YOUR TRANSFER.</p>-->
