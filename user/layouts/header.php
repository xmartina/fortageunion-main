    ...
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                ...
                <li onclick="trigerLogoBtn" class="nav-item toggle-sidebar margin-right-2">
                    <a onclick="trigerLogoBtn" href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom"><svg
